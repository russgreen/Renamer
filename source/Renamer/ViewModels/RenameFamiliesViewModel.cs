...
internal partial class RenameFamiliesViewModel : BaseRenameViewModel
{
    public RenameFamiliesViewModel() : base("Families", Host.GetService<ILogger<RenameFamiliesViewModel>>())
    {
    }
    ...
    protected override void LoadElements()
    {
        ...
        var models = families.Select(family => new ElementNameModel
        {
            Element = family,
            Category = family.FamilyCategory?.Name ?? "No Category",
            Name = family.Name,
            NewName = family.Name
        });
